...
class StockTwitsScraper(object):
    ...
    def storeTwits(self, batch):
        ...
        for twit in batch:
            ...
            #Check if this twit has already been stored
            ...
            #If this twit has not been stored, insert into collection
                ...
                try:
                    ...
                    print("Sentiment was {}, inserted into ticker collection. Size: {}".format(twit['sentiment']['class'], self.twit_collection.find({}).count()))
                except:
